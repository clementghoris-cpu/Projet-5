    ...
    def get_training_data(self) -> pd.DataFrame:
        ...
        try:
            ...
            df = pd.DataFrame([{
                ...
                "PropertyGFABuildings": td.PropertyGFABuildings,
                ...
                "SiteEUI_kBtu_sf": td.SiteEUI_kBtu_sf,
                "SiteEUIWN_kBtu_sf": td.SiteEUIWN_kBtu_sf,
                "SourceEUI_kBtu_sf": td.SourceEUI_kBtu_sf,
                "SourceEUIWN_kBtu_sf": td.SourceEUIWN_kBtu_sf,
                "SiteEnergyUse_kBtu": td.SiteEnergyUse_kBtu,
                "SiteEnergyUseWN_kBtu": td.SiteEnergyUseWN_kBtu,
    ...
    def save_prediction_input(self, input_data: dict) -> str:
        ...
        try:
            prediction_input = PredictionInput(
                ...
                PropertyGFABuildings=input_data.get("PropertyGFABuildings"),
