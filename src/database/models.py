...
class TrainData(Base):
    ...
    PropertyGFABuildings = Column(Integer, nullable=True)
    ...
    SiteEUI_kBtu_sf = Column(Float, nullable=True)
    SiteEUIWN_kBtu_sf = Column(Float, nullable=True)
    SourceEUI_kBtu_sf = Column(Float, nullable=True)
    SourceEUIWN_kBtu_sf = Column(Float, nullable=True)
    SiteEnergyUse_kBtu = Column(Float, nullable=True)
    SiteEnergyUseWN_kBtu = Column(Float, nullable=True)
