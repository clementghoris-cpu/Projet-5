...
class PredictionInput(BaseModel):
    ...
    PropertyGFAParking: int = Field(..., ge=0, alias="PropertyGFAParking", description="Surface de stationnement")
    property_gfa_buildings: int = Field(..., ge=0, alias="PropertyGFABuilding(s)", description="Surface totale des bâtiments")
    ...
    steam_use_kbtu: float | None = Field(None, ge=0, alias="SteamUse(kBtu)", description="Utilisation de la vapeur (kBtu)")
    #electricity_kwh: float | None = Field(None, alias="Electricity(kWh)")
    electricity_kbtu: float | None = Field(None, ge=0, alias="Electricity(kBtu)", description="Utilisation de l'électricité (kBtu)")
    #natural_gas_therms: float | None = Field(None, alias="NaturalGas(therms)")
    natural_gas_kbtu: float | None = Field(None, ge=0, alias="NaturalGas(kBtu)", description="Utilisation du gaz naturel (kBtu)")
